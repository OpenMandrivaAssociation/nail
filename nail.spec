...
ln -s mailx %{buildroot}%{_bindir}/mail
ln -s mailx %{buildroot}%{_bindir}/nail
ln -s mailx %{buildroot}%{_bindir}/Mail
ln -s mailx.1 %{buildroot}%{_mandir}/man1/mail.1
ln -s mailx.1 %{buildroot}%{_mandir}/man1/Mail.1
ln -s mailx.1 %{buildroot}%{_mandir}/man1/nail.1
